...
def parse_args():
    ...
    parser.add_argument("--max_steps", type=int, default=1000000, help="Max number of steps for training")
    ...
    parser.add_argument("--epsilon_end", type=float, default=0.2, help="Ending epsilon value for exploration")
    parser.add_argument("--warmup_steps", type=int, default=10000, help="Number of warmup steps before training starts")
    ...
    parser.add_argument("--loss_fn", type=str, default="MSE", choices=["MSE", "Huber"], help="Loss function")
    parser.add_argument("--eval_interval", type=int, default=2000, help="Interval for evaluation")
    parser.add_argument("--n_eval_episodes", type=int, default=100, help="Number of episodes to run for evaluation")
    parser.add_argument("--output_dir", type=str, default="outputs", help="Directory for output files")
    parser.add_argument("--accelerator", type=str, default="cpu", choices=["cpu", "gpu"], help="Training accelerator")
    ...
    parser.add_argument("--net_arch", type=int, nargs="+", default=[50, 50], help="Network architecture (list of layers)")
    parser.add_argument("--activation_fn", type=str, default="ReLU", choices=["ReLU", "Tanh", "Sigmoid"], help="Activation function")

    # EnvConfig arguments
    parser.add_argument("--problem_size", type=int, required=True, help="Size of the problem (depends on environment)")
